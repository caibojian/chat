...
import com.net.ossrs.yasea.SrsEncoder;
import com.net.ossrs.yasea.SrsFlvMuxer;
import com.net.ossrs.yasea.SrsMp4Muxer;
...
public class LiveVideoActivity extends Activity implements SurfaceHolder.Callback, Camera.PreviewCallback {
...
//    private String rtmpUrl = "rtmp://video-center.alivecdn.com/app-name/onlive.caibojian.com" + getRandomAlphaString(3) + '/' + getRandomAlphaDigitString(5);
    private String rtmpUrl = "rtmp://video-center.alivecdn.com/app-name/video-name?vhost=onlive.caibojian.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, String.format("RTMP URL %s", rtmpUrl));
        efu.setText(rtmpUrl);
